...
jr_00f_5d21:
    ...
    rst $38
    ld l, l
    ds 213, 0 ; 213 x nop ($00)

Call_00f_5dfb:
    ds 2248, 0 ; 2248 x nop ($00)

Jump_00f_66c3:
    ds 6461, 0 ; 6461 x nop ($00)
