...
jr_00c_4ef7:
    ds 2688, 0 ; 2688 x nop ($00)

Jump_00c_5977:
    ds 717, 0 ; 717 x nop ($00)

Call_00c_5c44:
    ds 3269, 0 ; 3269 x nop ($00)

Jump_00c_6909:
    ds 4591, 0 ; 4591 x nop ($00)

Call_00c_7af8:
    ds 1225, 0 ; 1225 x nop ($00)
